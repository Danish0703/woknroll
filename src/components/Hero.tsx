  ...
  return (
    <section className="relative h-[90vh] min-h-[600px] flex items-center justify-center overflow-hidden">
      <div
        ...
        style={{ backgroundImage: `url(/assets/hero-wok.jpg)` }}
      >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center sm:text-left">
        <div className="max-w-2xl">
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-white mb-6 animate-fade-in leading-tight">
          ...
          <Button
            ...
            className="hero-gradient text-white font-semibold text-lg px-8 py-7 rounded-full hover:scale-105 transition-smooth animate-fade-in shadow-lg"
